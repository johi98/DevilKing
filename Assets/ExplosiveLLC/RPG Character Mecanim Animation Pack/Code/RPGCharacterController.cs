...
namespace RPGCharacterAnims
{
    ...
    public class RPGCharacterController : MonoBehaviour
    {
        ...
        /// </summary>
        public bool isBlocking { get { return IsActive("Block"); } }

        /// <summary>
        /// Returns whether the Cast action is active.
        /// </summary>
        public bool isCasting { get { return IsActive("Cast"); } }

        /// <summary>
        /// Returns whether the ClimbLadder action is active. ClimbLadder is added by
        /// RPGCharacterMovementController.
        /// </summary>
        public bool isClimbing { get { return IsActive("ClimbLadder"); } }

        /// <summary>
        /// Returns whether the Crouch action is active.
        /// </summary>
        public bool isCrouching { get { return IsActive("Crouch"); } }

		/// <summary>
		/// Returns whether the Crouch action is active.
		/// </summary>
		public bool isCrawling { get { return IsActive("Crawl"); } }
        ...
        /// </summary>
        public bool isFacing { get { return IsActive("Face"); } }
        ...
        /// </summary>
        public bool isHipShooting { get { return IsActive("HipShoot"); } }
        ...
        /// RPGCharacterMovementController.
        /// </summary>
        public bool isRolling { get { return IsActive("Roll"); } }
        ...
        /// RPGCharacterMovementController.
        /// </summary>
        public bool isKnockdown { get { return IsActive("Knockdown"); } }
        ...
        /// </summary>
        public bool isSprinting { get { return IsActive("Sprint"); } }
        ...
        /// RPGCharacterMovementController.
        /// </summary>
        public bool isSwimming { get { return IsActive("Swim"); } }
        ...
        public void GetHit(int hitNumber)
        {
			...
			if (isBlocking) { Lock(false, true, true, 0.1f, 0.4f); }
			else { Lock(true, true, true, 0.1f, 0.4f); }
			SetIKPause(0.6f);
		}
